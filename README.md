...
RAIL20 is a Railgun-inspired privacy layer for ERC-20 tokens on Base. Users shield tokens into a shared anonymity pool, transact privately using PLONK zero-knowledge proofs, and unshield back to a public address whenever they want.
...
- Mainnet: live
- Audits: external review pending; RAIL20 inherits Railgun's audited primitives for ZK verification, Poseidon hashing, and the Merkle commitment tree
